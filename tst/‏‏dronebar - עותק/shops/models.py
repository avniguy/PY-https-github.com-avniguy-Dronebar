...
class Shop(models.Model):
    ...
    service_site = models.ForeignKey(ServiceSite,related_name='Shops',null=True,on_delete=models.CASCADE)
    menu = models.ForeignKey(Menu,related_name='menu',null=True,on_delete=models.CASCADE)
    # service_site = models.ForeignKey(ServiceSite,related_name='Shops', on_delete=models.CASCADE)
